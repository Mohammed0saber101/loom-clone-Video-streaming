...
const VIDEO_STREAM_BASAE_URL = BUNNY.STREAM_BASE_URL;
...
export const getVideoUploadUrl = withErrorHandling(async () => {
  ...
  const videoResponse = await apiFetch<BunnyVideoResponse>(
    `${VIDEO_STREAM_BASAE_URL}/${BUNNY_LIBRARY_ID}/videos`,
    {
      method: "POST",
      bunnyType: "stream",
  ...
  const uploadUrl = `${VIDEO_STREAM_BASAE_URL}/${BUNNY_LIBRARY_ID}/videos/${videoResponse.guid}`;
  return {
